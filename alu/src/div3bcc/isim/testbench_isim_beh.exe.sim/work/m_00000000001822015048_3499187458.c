...
#endif
static const char *ng0 = "D:/QUARTUS/GitHub/lab05-grupo15_/alu/src/div3bcc/div3bcc.v";
static int ng1[] = {1, 0};
static int ng2[] = {0, 0};
static int ng3[] = {3, 0};
...
LAB22:    xsi_set_current_line(50, ng0);
    ...
    t31 = ((char*)((ng1)));
    memset(t32, 0, 8);
    xsi_vlog_unsigned_lshift(t32, 3, t30, 3, t31, 32);
    t33 = (t0 + 2408);
...
LAB24:    xsi_set_current_line(52, ng0);
    ...
    t5 = ((char*)((ng1)));
    memset(t6, 0, 8);
    xsi_vlog_unsigned_lshift(t6, 3, t4, 3, t5, 32);
    t7 = (t0 + 2088);
...
LAB23:    xsi_vlogvar_assign_value(t8, t6, 0, *((unsigned int *)t32), 1);
    goto LAB24;
...
LAB33:    xsi_set_current_line(55, ng0);
    ...
    t7 = *((char **)t5);
    memset(t6, 0, 8);
    xsi_vlog_unsigned_minus(t6, 3, t4, 3, t7, 3);
    t5 = (t0 + 2408);
...
extern void work_m_00000000001822015048_3499187458_init()
{
	static char *pe[] = {(void *)Always_40_0};
	xsi_register_didat("work_m_00000000001822015048_3499187458", "isim/testbench_isim_beh.exe.sim/work/m_00000000001822015048_3499187458.didat");
